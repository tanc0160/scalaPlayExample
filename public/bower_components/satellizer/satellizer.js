        ...
        return function() {
          ...
          Oauth2.open = function(options, userData) {
            ...
            $timeout(function () {
			  ...
			  url += ("&nonce=" + (Math.random().toString(16) + "000000000").substr(2, 8));
              ...
              openPopup
                .then(function(oauthData) {
                  ...
                  // Satellizer's magic by doing authorization code exchange and
                  // saving a token manually.
                  if (defaults.responseType === 'token' || defaults.responseType === 'id_token' 
					|| defaults.responseType === 'id_token+token' || !defaults.url) {
          ...
          Oauth2.exchangeForToken = function(oauthData, userData) {
			...
			return $http({
					...
					data: "client_id=" + data.clientId + "&grant_type=authorization_code&code=" + data.code 
